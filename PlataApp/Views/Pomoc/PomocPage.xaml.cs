...
public partial class PomocPage : Page
{
    private readonly List<PomocTema> _teme = new()
    {
        new PomocTema
        {
            ...
            Sadrzaj =
                "PlataApp je desktop aplikacija za kompletnu obradu mesečnih zarada zaposlenih — od unosa radnih sati do generisanja platnih spiskova, rekapitulacija i izveštaja za banke.\n\n" +
